...
def test_warp_credential_contract_is_current():
    ...
    # The same checks the source fragments get. The bundler only resolves refs -
    # it validates no wording - so a bundled description can drift from the
    # fragment it came from, and checking a subset here let exactly that pass.
