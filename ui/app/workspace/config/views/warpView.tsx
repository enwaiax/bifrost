...
import { isFiniteNumber, isValidBaseURL } from "./warpView.utils";
...
export default function WarpView() {
	...
	const retentionInvalid = !isFiniteNumber(form.historyRetentionDays) || form.historyRetentionDays < 1;
					...
					<div className="space-y-4">
						...
						<div className="space-y-2 rounded-sm border p-4">
							...
							<Input
								...
								disabled={!hasSettingsUpdateAccess}
							/>
							{retentionInvalid && <p className="text-destructive text-sm">Must be at least 1 day</p>}
						</div>
